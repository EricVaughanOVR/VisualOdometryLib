...
void fast12_score(const byte* i, int stride, FeatureList& corners, int b)
{	
	int n;
    ...
    for(n=0; n < corners.allFeatures.size(); n++)
        corners.allFeatures[n].score = fast12_corner_score(i + corners.allFeatures[n].y*stride + corners.allFeatures[n].x, pixel, b);
}


void fast12_detect(const byte* im, int xsize, int ysize, int stride, int b, FeatureList& corners)
{
